<template>
  <div class="cont_principal">
    <div class="cont_central">
      <div class="cont_modal" :class="{ 'cont_modal_active': isModalOpen }">
        <div class="cont_photo">
          ...
          <div class="cont_detalles">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sagittis est aliquam, sed faucibus massa lobortis. Maecenas non est justo.</p>
          </div>
        </div>
...
export default {
  data() {
    return {
      isModalOpen: false,
      tabs: ['INGREDIENTS', 'PREPARATION'],
      preparationSteps: [
        'Heat oven to 375 degrees.',
        'Heat oil in a large skillet over medium-low heat. Add onion and bell pepper...',
